---
search: false
title: 'Legacy Project Collection'
---
...
> This section focuses on evaluation dimensions specific to Deep Research. For the broader Agentic evaluation system, including tool invocation, end-to-end tasks, benchmark landscape, and evaluation-system construction, see [the supplemental page on industrial practice, evaluation, and bad cases](./industrial-evaluation).
